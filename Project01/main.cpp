//USER OF FILE: Logan Kelsch
//COSC 320 Project01
//Code slightly manipulated for the purpose of this project
/*
Author: Don Spickler
...
int main() {
  ...
  //int value to perserve original size value through for loop manipulation
  int nStart = n;
//5 test run loop
...
for(int i=0;i<10;i++){
  if (intdata) {
    ...
    B = new double[n];
    for_each(B, B + n, [mod](double &i) { i = static_cast<double>(rand()% mod) / mod; });
